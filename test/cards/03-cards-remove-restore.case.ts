...
export default () => {
  describe('Test cards training responses', () => {
    ...
    let initialShelfId;
    // получить все карточки aggregate/view
    // удалить в корзину все карточки
    // проверить, что все карточки удалены в корзину
    // восстановить все карточки в коробку с новыми карточками
    // удалить в корзину все карточки
    // восстановить все карточки в коробку с индкесом 1
    // удалить в корзину все карточки
    // восстановить все карточки в коробку с новыми изученными
    // удалить в корзину все карточки
